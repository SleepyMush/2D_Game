...
int Windows::CreateWindow(int screenWidth, int screenHeight, const char* Windowname)
{
	glfwInit();
...
void Windows::glDebugOutput(GLenum source, GLenum type, unsigned int id, GLenum severity, GLsizei length, const char* message, const void* userParam)
{
//	__debugbreak();
